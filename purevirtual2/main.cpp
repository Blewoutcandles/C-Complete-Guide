...
int main(){
    ...
    /*when invoking the emp_nina.get_total_compensation() as it have only get_stock compensation, it relies on the parent class
    FULLTIMEEIMPLOYEE class, so get_total_salary() will be invoked from fulltimeclass.*/
